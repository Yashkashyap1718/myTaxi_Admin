                              ...
                              : DataTable(
                                  ...
                                  rows: controller.languageList
                                      .map((languageModel) => DataRow(cells: [
                                            DataCell(TextCustom(
                                                title:
                                                    "${controller.languageList.indexWhere((element) => element == languageModel) + 1}")),
                                            DataCell(TextCustom(
                                                title:
                                                    "${languageModel.name}")),
                                            DataCell(TextCustom(
                          ...
                          children: [
                            Expanded(
                                child: CustomTextFormField(
                                    hintText: 'Enter Language Name'.tr,
                                    controller:
                                        controller.languageController.value,
                                    title: 'Name *'.tr)),
                            spaceW(width: 24),
                            Expanded(
                                child: CustomTextFormField(
                                    hintText: 'Enter Language Code'.tr,
