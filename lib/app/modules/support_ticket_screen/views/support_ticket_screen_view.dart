...
class SupportTicketScreenView extends GetView<SupportTicketScreenController> {
                          ...
                          SingleChildScrollView(
                            ...
                            child: ClipRRect(
                                ...
                                child: controller.isLoading.value
                                    ...
                                    : controller.currentPageSupportTicketList
                                            .isEmpty
                                        ? TextCustom(
                                        ...
                                        : DataTable(
                                            ...
                                            rows: controller
                                                .currentPageSupportTicketList
                                                .map((supportTicketModel) =>
                                                    DataRow(cells: [
                                                      DataCell(TextCustom(
                                                          title: supportTicketModel
                                                                  .id!.isEmpty
                                                              ? "N/A"
                                                              : supportTicketModel
                                                                  .id
                                                      ...
                                                      //         } else {
                                                      //           var userName = (supportTicketModel.type ==
                                                      //                   "customer"
                                                      //               ? (snapshot.data
                                                      //                       as UserModel)
                                                      //                   .fullName
  ...
  supportTicketDetail(BuildContext context, SupportTicketModel ticketModel,
      SupportTicketScreenController controller) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return Dialog(
      backgroundColor: themeChange.isDarkTheme()
          ? AppThemData.greyShade950
                ...
                children: [
                  Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          TextCustom(
                              title: '${controller.title}'.tr, fontSize: 18),
                          InkWell(
                            onTap: () {
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  //       ? FireStoreUtils
                                  //           .getCustomerByCustomerID(
                                  //               ticketModel.userId.toString())
                                  //       : FireStoreUtils.getDriverByDriverID(
                                  //           ticketModel.userId.toString()),
                                  //   builder: (BuildContext context,
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  TextCustom(
                                    title: ticketModel.type == "customer"
                                        ? "Customer"
                                        : "Driver",
                                    color: themeChange.isDarkTheme()
                                        ? AppThemData.greyShade25
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  TextCustom(
                                    title:
                                        "Constant.timestampToDate(ticketModel.createAt!)",
                                    color: themeChange.isDarkTheme()
                                        ? AppThemData.greyShade25
                                        : AppThemData.greyShade950,
                                    fontSize: 16,
                                ...
                                CustomButtonWidget(
                                    ...
                                    onPress: () async {
                                      if (Constant.isDemo) {
                                        ...
                                        if (controller.notesController.value
                                            .text.isNotEmpty) {
