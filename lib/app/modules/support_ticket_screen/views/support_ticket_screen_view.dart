...
class SupportTicketScreenView extends GetView<SupportTicketScreenController> {
                                    ...
                                    : controller.currentPageSupportTicketList.isEmpty
                                        ...
                                        : DataTable(
                                            ...
                                            columns: [
                                              ...
                                              CommonUI.dataColumnWidget(context, columnTitle: "Name".tr, width: 100),
                                              CommonUI.dataColumnWidget(context, columnTitle: "Reason".tr, width: 250),
                                            ...
                                            rows: controller.currentPageSupportTicketList
                                                .map((supportTicketModel) => DataRow(cells: [
                                                      DataCell(TextCustom(
                                                          title:
                                                              supportTicketModel.id!.isEmpty ? "N/A" : supportTicketModel.id.toString())),
                                                      ...
                                                      DataCell(TextCustom(
                                                          title: supportTicketModel.title!.isEmpty
                                                              ? "N/A"
                                                              : supportTicketModel.title.toString())),
                                                      DataCell(TextCustom(
                                                          title: supportTicketModel.type == "customer" ? "Customer".tr : "Driver".tr)),
                                                      DataCell(Container(
                                                      ...
                                                      DataCell(IconButton(
                                                        onPressed: () {
                                                          ...
                                                          showDialog(
                                                              context: context,
                                                              builder: (context) =>
                                                                  supportTicketDetail(context, supportTicketModel, controller));
                                                        },
                                                        icon: const Icon(
                                                          Icons.info_outline,
                                                          color: AppThemData.greyShade500,
  ...
  supportTicketDetail(BuildContext context, SupportTicketModel ticketModel, SupportTicketScreenController controller) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return Dialog(
      backgroundColor: themeChange.isDarkTheme() ? AppThemData.greyShade950 : AppThemData.greyShade50,
