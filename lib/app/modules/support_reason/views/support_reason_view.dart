                        ...
                        : DataTable(
                            ...
                            columns: [
                              CommonUI.dataColumnWidget(context,
                                  columnTitle: "Id".tr,
                                  width: ResponsiveWidget.isMobile(context) ? 20 : MediaQuery.of(context).size.width * 0.05),
                              CommonUI.dataColumnWidget(context,
                                  columnTitle: "Reason".tr,
                                  width: ResponsiveWidget.isMobile(context) ? 200 : MediaQuery.of(context).size.width * 0.22),
                              CommonUI.dataColumnWidget(context,
                                  columnTitle: "Type".tr,
                                  width: ResponsiveWidget.isMobile(context) ? 100 : MediaQuery.of(context).size.width * 0.10),
                              CommonUI.dataColumnWidget(context,
                                  columnTitle: "Actions".tr,
                                  width: ResponsiveWidget.isMobile(context) ? 80 : MediaQuery.of(context).size.width * 0.10),
                            ],
