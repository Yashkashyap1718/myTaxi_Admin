                              ...
                              : DataTable(
                                  ...
                                  rows: controller.taxesList
                                      .map((taxModel) => DataRow(cells: [
                                            DataCell(TextCustom(
                                                title:
                                                    "${controller.taxesList.indexWhere((element) => element == taxModel) + 1}")),
                                            DataCell(TextCustom(
                                                title: "${taxModel.name}")),
                                            DataCell(
                                              TextCustom(
                                            ...
                                            DataCell(TextCustom(
                                                title: "${taxModel.country}")),
                                            DataCell(TextCustom(
                                                title: taxModel.isFix!
                                                    ? "Fix"
                                                    : "Percentage")),
                                            DataCell(
                                              Transform.scale(
              ...
              children: [
                Expanded(
                    child: CustomTextFormField(
                        hintText: 'Enter Tax Title'.tr,
                        controller: controller.taxTitle.value,
                        title: 'Title *'.tr)),
                spaceW(width: 24),
                Expanded(
                    child: CustomTextFormField(
                        hintText: 'Enter Tax Amount'.tr,
                        controller: controller.taxAmount.value,
                        title: 'Amount *'.tr)),
              ],
            ),
            spaceH(),
                ...
                CustomButtonWidget(
                  ...
                  onPress: () {
                    if (Constant.isDemo) {
                      ...
                      if (controller.taxTitle.value.text != "" &&
                          controller.taxAmount.value.text != "") {
